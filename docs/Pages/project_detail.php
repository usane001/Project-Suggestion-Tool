...
<?php if(isset($_GET['dattyp'])){ ?>
	<a href="SuggestProjectIndex.php?page=SuggestProject&io=1" class="btn btn-sm btn-info"> DONE </a>
	...
	<a href="SuggestProjectIndex.php?page=SuggestProject&io=1" class="btn btn-sm btn-info"><i class="fa fa-"></i> Back </a>
	<?php } ?>
	<a href="SuggestProjectIndex.php?page=update_progress&id=<?php echo $_GET['id'] ?>" class="btn btn-sm btn-info"><i class="fa fa-chart"></i> Update Progress </a>

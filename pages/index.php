...
$pages = array('home','position','employee','employee_profile','division','project_list','project_detail','progress','update_progress','user_list','attendance','project_team','Home1', 'Browse Categories');
if (!empty($page)) {

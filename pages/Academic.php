    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                <a class="navbar-brand" href=""><i class="fa fa-pencil fa-fw"></i> Project Suggestion Tool</a>
            </div>
            <!-- Top Menu Items -->
...
$page = isset($_GET['page']) && !empty($_GET['page']) ? $_GET['page'] : 'Academic1';
$pages = array('Academic1','home','position','employee','employee_profile','division','project_list','project_detail','progress','update_progress','user_list','attendance','project_team','categories');
if (!empty($page)) {

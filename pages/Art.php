...
$page = isset($_GET['page']) && !empty($_GET['page']) ? $_GET['page'] : 'Art1';
$pages = array('Art1','home','position','employee','employee_profile','division','project_list','project_detail','progress','update_progress','user_list','attendance','project_team','categories');
if (!empty($page)) {

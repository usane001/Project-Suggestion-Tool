...
$page = isset($_GET['page']) && !empty($_GET['page']) ? $_GET['page'] : 'Business1';
$pages = array('Business1','home','position','employee','employee_profile','division','project_list','project_detail','progress','update_progress','user_list','attendance','project_team','categories');
if (!empty($page)) {
